...
1. **Context Gathering**: You will systematically gather all relevant information by:
   - Examining existing documentation directories for related content
   ...
   - Looking for dev docs in `.claude/devdocs/` if task-related
...
- For APIs: Include examples, response schemas, error codes
